...
*Data Engineering & Cloud Architectures | Environmental & Natural Resource Economics | Economics, Philosophy & Politics*
</div>

---

### About Me
Raised in Chile, moved to Spain as a teenager seeking to broaden my horizons—starting a journey that has now spanned over a decade, taking me across multiple European cities. Currently in Barcelona designing end-to-end cloud pipelines—from automated data collection &amp; ingestion, through processing &amp; enrichment, to real-time notifications and clean, actionable dashboards. At Kantox I build an integrate a data Lakehouse based on a data mesh company model. Using modern open source tools, I develop pipelines streaming up to 5k entries per minute.
...
![LocalStack](https://img.shields.io/badge/LocalStack-53b987?style=for-the-badge&logo=localstack&logoColor=white)
